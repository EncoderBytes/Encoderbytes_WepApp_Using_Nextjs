...
const CaseStudyPage = ({ searchParams }) => {
  ...
  const projectTechnology = project
    ? parseJsonField(project.ProjectTechnology, [])
    : [];

  // Parse project statistics for charts, show 0 if backend sends 0
  const errorsResolved =
    project &&
    project.errorsResolved !== undefined &&
    project.errorsResolved !== null
      ? parseInt(project.errorsResolved)
      : 75;
  const userIncreased =
    project &&
    project.userIncreased !== undefined &&
    project.userIncreased !== null
      ? parseInt(project.userIncreased)
      : 90;
  console.log(errorsResolved, userIncreased);

  if (!loading && !projectId) {
    return <p className="text-center mt-20 text-xl">Invalid project ID</p>;
  }
  ...
  return (
    <>
      <Top />
      <div
        className="max-w-full flex flex-col gap-10 justify-center items-center mt-10 md:mt-20 text-white bg-[#f9a4a4]"
      ...
      {/* Overview Section */}
      <div className="flex flex-col md:flex-row justify-between items-center px-6 md:px-12 mt-20 md:mt-32 md:gap-x-16 mb-32">
        ...
        <div className="w-full md:w-[30%] h-auto md:h-full relative mt-5 md:mt-0">
          <div className="bg-custom-blue-light w-[250px] h-[139px] rounded-[10px] m-auto uppercase">
            <div className="bg-custom-blue rounded-t-[10px] h-10 flex items-center justify-center">
              <h2 className="font-bold text-white tracking-custom">
                Project Timeline
              </h2>
            </div>
            <div className=" bg-[#b2cef54d] rounded-b-[10px] flex items-center justify-center h-[99px]">
              <h2 className="flex items-center justify-center text-[#454544] font-medium ">
                {loading ? (
      ...
      <div className="p-4 md:px-20" id="mobilesection3">
        <div className="flex justify-center items-center flex-col gap-y-3 mt-8">
