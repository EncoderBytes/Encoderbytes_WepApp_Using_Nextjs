...
export async function POST(request) {
  try {
    ...
    const { ProjectName, ProjectCategory, ProjectDescription } = Object.fromEntries(data.entries());
    ...
    const [insertResult] = await db.query(
      `INSERT INTO project (ProjectName, ProjectCategory, ProjectDescription, Image, publicId)
       VALUES (?, ?, ?, ?, ?)`,
      [ProjectName, ProjectCategory, ProjectDescription, imageUrl, publicId]
    );
