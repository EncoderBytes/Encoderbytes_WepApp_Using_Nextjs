    ...
    <div className="bg-white">
      ...
      >
        <div className="flex flex-col justify-center items-center py-24 mt-24">
          ...
          <div className="flex  m-auto py-3">
            <p className="flex w-5/6 md:w-5/6 m-auto justify-center items-center text-center text-xl leading-4 font-medium">
          ...
          <a
            href="/"
            className="text-black font-bold mt-20 text-center md:text-left text-xl"
          >
      ...
      <div className="mt-32 md:mt-32 w-full  bg-gray-200 p-5 md:w-4/6 md:m-auto rounded-md font-bold h-auto ">
        ...
        <ul className="flex gap-2 md:gap-5 justify-center h-auto  ">
          <li className="hover:text-custom-blue text-gray-400 cursor-pointer text-sm md:text-xl">
            ALL
          </li>
          <li className="hover:text-custom-blue cursor-pointer text-gray-400 text-sm md:text-xl">
            MOBILE APP
          </li>
          <li className="hover:text-custom-blue cursor-pointer text-sm text-gray-400 md:text-xl">
            WEB APP
          </li>
          <li className="hover:text-custom-blue cursor-pointer text-sm md:text-xl text-gray-400">
        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="px-6 py-4">
              ...
              <p className="text-xl text-gray-400 mt-5 w-11/12">
                {project.description}
              </p>
              <div className="mt-10">
                <a
