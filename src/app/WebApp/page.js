...
const WebAPP = () => {
  ...
  const getProjects = async () => {
    try {
      ...
      const webAppProjects = admins.filter(
        (p) => p.ProjectCategory === "Web App"
      );
    ...
    <div className=" bg-white">
      ...
      <div className="bg-custom py-10">
        <div className="flex justify-center items-center flex-col mt-4">
          <div className="text-custom-blue text-4xl font-bebas text-center gap-2 tracking-custom">
      ...
      <section className="mt-[5%] px-8 md:px-16  ">
        <div className="w-full py-16 ">
          ...
          >
            <div className="pt-10 text-2xl md:text-[40px] font-bebas text-center tracking-custom">
      ...
      <div className="w-full px-8">
        <div className="flex justify-center items-center  flex-col mt-14 ">
          ...
          <div className=" grid grid-cols-1 md:grid-cols-6 gap-5 w-5/6 mt-10">
            {WebSecapps.map((items) => {
              return (
                <div
                  key={items.image}
                  className=" bg-[#F5F5F6] rounded-lg border-black p-10 md:p-0 w-[185px]h-[140px] gap-5 text-center flex flex-col justify-center items-center"
                >
                  <Image src={items.image} alt="image" width={60} height={60} />
                  <span className="text-sm">{items.name}</span>
                </div>
                            ...
                            >
                              ...
                              <div className="flex flex-col justify-center items-center md:items-start gap-y-5 text-center md:text-left md:w-[50%]">
                                ...
                                <p className="text-paraClr leading-tight">
                                  Currently, there are no Web Applications projects available to
              ...
              style={{ 
                backgroundColor: index % 2 === 0 
                  ...
                  >
                    ...
                    >
                      <div className="relative md:w-[700px] h-[420px]">
                        <Image
                          src={project.Image || "/backgrounds/app2.png"}
                          alt={project.ProjectName || "Project Image"}
                          className="object-cover rounded-lg md:w-[700px] md:h-[400px] h-full w-full"
                          width={400}
                          height={250}
                          onError={(e) => {
                            e.target.src = "/backgrounds/app2.png";
                ...
                >
                  ...
                  <div className="flex flex-col justify-center items-center md:items-start gap-y-5 text-center md:text-left md:w-[50%]">
                    ...
                    <p className="text-paraClr leading-tight">
                      Currently, there are no Web App projects available to
                      display. Please check back later or contact us for more
                      information.
                    </p>
                    <div className="text-white rounded-md w-40 h-11 border-2 hover:bg-custom-blue border-white text-center justify-center cursor-pointer flex items-center font-bold">
