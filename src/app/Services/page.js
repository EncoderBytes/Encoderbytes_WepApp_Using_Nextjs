...
const Services = () => {
  return (
    <div className="bg-white">
      ...
      {/* 2 section */}
      <div className="flex flex-col md:flex-row justify-center items-center px-6 md:px-12 mt-20 md:mt-20 md:gap-x-8 mb-32">
      ...
      <section className="pb-10 pt-10 W-5/6">
                <div className="flex flex-col-reverse md:flex-row justify-center items-center px-6 md:px-12 mt-20 md:mt-20 gap-y-8 md:gap-x-8  m-auto p-5 rounded-md">
          <div className="flex flex-col justify-center items-center md:items-start gap-y-3 text-center md:text-left md:w-[50%]">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center px-6 md:px-12 mt-20 md:mt-20 gap-y-8 md:gap-x-8  m-auto p-5 rounded-md">
          <div className="bg-yellow w-full md:w-[50%] h-auto md:h-full relative">
            <Image
