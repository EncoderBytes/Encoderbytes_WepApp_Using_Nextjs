...
import { Cartobj, fallbackServices } from "./components/carts";
...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchLatestProject() {
      try {
        ...
        const latestProjects = data.Result?.filter(
  ...
  // Fetched Cards Data From Backend (Our Approaches Sec)
  useEffect(() => {
  ...
  return (
    <div className="bg-white">
      ...
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center md:items-start md:ml-12 px-6 md:px-0 text-center md:text-left">
            ...
            {[
              ...
              <div
                ...
                className={`py-5 md:py-24 w-60 flex flex-col items-center text-white  mt-3 ${
                  index !== 4 ? "md:border-r border-white md:border-r-0.5" : ""
                }`}
              >
      ...
      <div className="md:px-10 w-full">
        ...
        <div className="mt-7 md:mt-3 ml-4 md:ml-3 md:w-8/12">
          <p className="text-paraClr leading-tight">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center px-6 md:px-12 mt-20 gap-y-8 md:gap-x-8">
        ...
        <div className="flex flex-col justify-center items-center lg:items-start gap-y-4 text-center lg:text-left lg:w-[50%]">
          <div className="text-2xl font-bold text-paraClr border-b-4 border-custom-blue">
            {loading ? (
              ...
              <h1>
                ...
                <span>
                  {" "}
                  u z <span className="text-custom-blue">.</span>
                </span>
              </h1>
            )}
          </div>
          ...
          {loading ? (
            ...
            <p>
              We have delivered numerous web, mobile, UI/UX, and AI projects
              recently, and the most recent project we have completed is
              detailed below.
            </p>
          )}
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-7 px-2  md:mt-3 md:px-10 ml-4 md:w-8/12">
          <p className="text-paraClr leading-tight">
        ...
        <div className="flex flex-col px-6 md:px-12 mt-10 md:mt-14 gap-y-8 md:gap-x-8">
          <div className="flex flex-col md:flex-row justify-center items-center gap-y-8 md:gap-x-8">
            <div className="flex flex-col justify-center items-center md:items-start gap-y-5 text-center md:text-left md:w-[50%]">
              <div className="text-2xl font-bold">
                <span className="border-b-4 border-custom-blue">I n d u</span>
              ...
              {loading ? (
                ...
                <p className="text-paraClr leading-tight">
                  We are helping and educating doctors and other people through
                  our applications. Our app is ranked in the top five in the
                  health category in Pakistan. We provide management systems to
                  the health industry.
                </p>
              )}
      ...
      <div className="flex flex-col-reverse md:flex-row justify-center items-center px-6 md:px-12 mt-20 gap-y-8 md:gap-x-8">
        ...
        <div className="flex flex-col justify-center items-center md:items-start gap-y-5 text-center md:text-left md:w-[50%]">
          ...
          {loading ? (
            ...
            <p className="text-paraClr leading-tight">
              We are helping and educating doctors and other people through our
              applications. Our app is ranked in the top five in the health
              category in Pakistan. We provide management systems to the health
              industry.
            </p>
          )}
