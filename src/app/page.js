      ...
      <div className="flex flex-col md:px-12 pb-16 bg-greybg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  mt-8 w-12/12 gap-5 m-auto">
          ...
          },
          {
            ...
            <div key={index} className="rounded-lg   bg-white p-4 md:w-100 mt-4 md:mt-0">
              <div className="flex justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10 px-4 md:px-12 m-auto">
          {Cartobj.map((cart) => (
            <div className="rounded-lg bg-white p-4" key={cart.no}>
              ...
              <div className="flex flex-col md:w-full ml-2 mt-6">
                <p className="text-4xl font-bebas tracking-custom -mb-2 text-custom-blue">{cart.heading}
                </p>
                <p className="mt-6 text-paraClr opacity-50 capitalize leading-tight">
                  {cart.description}
                </p>
