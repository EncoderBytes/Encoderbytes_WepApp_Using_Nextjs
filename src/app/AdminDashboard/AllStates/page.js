          ...
          <div className="overflow-x-auto h-[500px]">
            <table className="min-w-[700px] border border-gray-300">
              <thead className="bg-gray-200">
                <tr>
                  <th className="px-4 py-2">Projects Delivered</th>
                  <th className="px-4 py-2">Happy Clients</th>
                  <th className="px-4 py-2">Global Office</th>
                  <th className="px-4 py-2">Years In Business</th>
                  <th className="px-4 py-2">Expert Team</th>
